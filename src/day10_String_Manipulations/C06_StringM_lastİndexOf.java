...
public class C06_StringM_lastİndexOf {
    public static void main(String[] args) {
        ...
        System.out.println(str.lastIndexOf("a", 19)); //18 + (19.indexen baslayrk basa dogru sayar kacıncı indexde old bulur
        System.out.println(str.lastIndexOf('y',16));
